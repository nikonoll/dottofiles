...
map  l :SyntasticCheck
nnoremap  k :bprevious
nnoremap  j :bnext
nnoremap  w :w
nnoremap "," za
nnoremap K :grep! "\b\b":cw
...
vmap <F7> <Plug>ToggleBackground
nmap <F7> <Plug>ToggleBackground
...
set shortmess=aoO
badd +0 ~/dottofiles/.vimrc
argglobal
silent! argdel *
argadd .vimrc
edit ~/dottofiles/.vimrc
...
let s:l = 64 - ((61 * winheight(0) + 33) / 67)
